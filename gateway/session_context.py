...
# WS3: persona/role multiplexed within a single channel (e.g. the WhatsApp role
# router). Read per-operation by the memory provider to resolve a per-role bank.
_SESSION_ROLE: ContextVar = ContextVar("HERMES_SESSION_ROLE", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_SESSION_ROLE": _SESSION_ROLE,
